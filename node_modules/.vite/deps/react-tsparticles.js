...
function deepExtend(destination, ...sources) {
	for (const source of sources) {
		...
		if (sourceIsArray && (isObject$1(destination) || !destination || !Array.isArray(destination))) destination = [];
		else if (!sourceIsArray && (isObject$1(destination) || !destination || Array.isArray(destination))) destination = {};
...
var randomColorValue = "random", colorManagers = /* @__PURE__ */ new Map();
...
var Move = class {
	...
	load(data) {
		...
		if (outModes !== void 0) if (isObject$1(outModes)) this.outModes.load(outModes);
